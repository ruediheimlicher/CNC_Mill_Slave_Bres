 ...
 */
{
   ...
   if (dx > dy)
   {
      ...
      deltafastdirection = dx;   // Delta in schneller Richtung
   }
   else
   {
      ...
      deltaslowdirection = dx;   // Delta in langsamer Richtung 
      deltafastdirection = dy;   // Delta in schneller Richtung 
   }
